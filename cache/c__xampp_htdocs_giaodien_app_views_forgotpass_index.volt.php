            ...
            <div id="passwordreset" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form id="forgot-form" action="<?= $this->url->get('forgotpass/forgotpass') ?>" class="form-horizontal" role="form" method= "POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="  col-sm-offset-5 col-sm-7">
                                    ...
                                    <a href="/giaodien/loginregis" style="margin-left:10px;">Quay về</a>
                                </div>                            
                            </div>                             
                        </form>
                    </div>
